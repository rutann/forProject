...
<div class="topnav">
  ...
  <a href="/order/ordersList">Orders list </a>
	...
	<div class="container">
	<h2>Fill form to create new Sale person</h2>
		<form:form action="/salePeople/createNewSalePerson" method="post" modelAttribute="salePerson">
  ...
  <input type="submit"  formaction="/salePeople/createNew" value="Create"/><br>
